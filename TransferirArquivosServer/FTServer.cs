    ...
    internal class FTServer
    {
        ...
        public static void IniciarServidor()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ListaMensagem.Items.Add("Erro ao inicializar servidor: " + ex.Message);
            ...
            try
            {
                ...
                Socket clienteSocket = sock_Servidor.Accept();
                clienteSocket.ReceiveBufferSize = 16384;
            ...
            catch (SocketException ex)
            {
                ListaMensagem.Invoke(new Action(() =>
                {
                    ListaMensagem.Items.Add("Erro ao receber arquivos: " + ex.Message);
                    ListaMensagem.SetSelected(ListaMensagem.Items.Count - 1, true);
                }));
            }
            finally
